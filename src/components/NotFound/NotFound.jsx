      ...
      <div className="not-found__container">
        ...
        <div className="not-found__icon-container">
          ...
          >
            <path
              style={{ fill: "#5D9CEC" }}
              d="M454.301,386.456l-1.812-0.531c-26.452-7.094-35.405-13.938-47.171-18.391
            ...
            <path
              style={{ fill: "#DBAFA5" }}
              d="M376.288,354.862L376.288,354.862c-3.234-1.656-6.109-3.234-8.641-4.75l0,0
            ...
            <path
              style={{ fill: "#EAC6BB" }}
              d="M387.693,191.759c0,89.294-85.138,171.462-137.425,171.462c-52.303,0-137.433-82.168-137.433-171.462
              S174.364,43.553,250.268,43.553C326.164,43.553,387.693,102.465,387.693,191.759z"
            />
            <path
              style={{ fill: "#4A89DC" }}
              d="M376.288,354.862c-8.672-4.438-14.609-8.311-18.641-11.592c-4.922,4.594-12.375,10.795-22.249,16.967
            ...
            <path
              style={{ fill: "#ED5564" }}
              d="M260.925,10.656c0,5.882-4.774,10.656-10.656,10.656c-5.891,0-10.656-4.773-10.656-10.656
              C239.613,4.765,244.379,0,250.269,0C256.151-0.001,260.925,4.765,260.925,10.656z"
            />
            <path
              style={{ fill: "#E6E9ED" }}
              d="M250.261,10.656c-76.982,0-141.808,63.49-141.808,141.808l-0.008,39.358h283.624l0.016-39.358
              C392.084,74.146,327.242,10.656,250.261,10.656z"
            />
            <path
              style={{ fill: "#ED5564" }}
              d="M404.333,182.408c0,0-28.982-54.529-154.064-54.529S96.195,182.408,96.195,182.408
              c-2.75,5.172-0.211,9.406,5.656,9.406h296.827C404.552,191.814,407.083,187.579,404.333,182.408z"
            />
            <path
              style={{ fill: "#DA4453" }}
              d="M402.895,180.15c-1.093,0.641-2.499,1.008-4.218,1.008H101.851c-1.711,0-3.133-0.367-4.226-1.008
            ...
            <g>
              <path
                style={{ fill: "#ED5564" }}
                d="M250.261,42.623c-17.656,0-31.968,14.312-31.968,31.968c0,17.655,14.312,31.975,31.968,31.975
              ...
              <path
                style={{ fill: "#ED5564" }}
                d="M420.77,341.02c-46.998,0-85.247,38.248-85.247,85.246c0,47.014,38.249,85.248,85.247,85.248
                c47.014,0,85.248-38.234,85.248-85.248C506.018,379.268,467.784,341.02,420.77,341.02z"
              />
            </g>
            <path
              style={{ fill: "#E6E9ED" }}
              d="M335.742,432.579c3.25,44.061,40.14,78.936,85.028,78.936c45.748,0,83.201-36.219,85.17-81.498
              L335.742,432.579z"
            />
            <path
              style={{ fill: "#434A54" }}
              d="M504.956,439.798c0.703-4.406,1.062-8.922,1.062-13.531c0-2.812-0.125-5.609-0.406-8.375
            ...
            <path
              style={{ fill: "#E6E9ED" }}
              d="M442.083,436.923c0,11.781-9.531,21.312-21.312,21.312c-11.766,0-21.312-9.531-21.312-21.312
              c0-11.766,9.546-21.312,21.312-21.312C432.552,415.61,442.083,425.157,442.083,436.923z"
            />
            <path
              style={{ fill: "#434A54" }}
              d="M420.77,468.889c-17.625,0-31.968-14.342-31.968-31.967s14.343-31.967,31.968-31.967
            ...
            <path
              ...
              d="M420.77,341.02c-1.781,0-3.562,0.062-5.312,0.156
